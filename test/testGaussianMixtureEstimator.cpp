...
void findMinMax(const cudars::VectorVector2& points, cudars::Vector2& pmin, cudars::Vector2& pmax);

void rangeToPoint(double* ranges, int num, double angleMin, double angleRes, double rangeMax, cudars::VectorVector2& points);

void plotEllipse(std::ostream& out, int idx, const cudars::Vector2& mean, const cudars::Matrix2& covar);

void plotEllipses(std::ostream& out, const cudars::VectorVector2& means, const cudars::VectorMatrix2& covars);
